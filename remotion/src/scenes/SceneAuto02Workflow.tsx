...
const NODES = [
  { num: '①', label: 'Déclencheur Lundi', sub: '8h00 hebdomadaire' },
  { num: '②', label: 'Filtre Contacts', sub: 'Email ou GSM manquant' },
  { num: '③', label: 'Construire lien', sub: 'Formulaire personnalisé' },
  { num: '④', label: 'Email de collecte', sub: 'Envoi client par client' },
  { num: '⑤', label: 'Attente 3 jours', sub: 'Puis vérification réponse' },
  { num: '⑥', label: 'Rapport Manager', sub: 'Résumé hebdomadaire' },
];

export const SceneAuto02Workflow: React.FC = () => {
  ...
  return (
    <AutoSceneWrapper accent={ACCENT} sceneNum={4}>
      <div
        style={{
          position: 'absolute',
          top: 100,
      ...
      >
        ...
        <div style={{ flexShrink: 0, width: 340, display: 'flex', flexDirection: 'column', gap: 18 }}>
          ...
          <div style={{ opacity: fadeO(12), transform: `translateX(${slideX(12)}px)` }}>
            ...
            >
              Chaque lundi, le workflow filtre les contacts sans email ou GSM, leur envoie un formulaire de mise à jour, puis relance automatiquement à J+3 et J+7 si aucune réponse n'est reçue.
            </div>
          </div>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                n8n · Enrichissement Contacts — Courtis
              </div>
            </div>
            ...
            <div style={{ background: '#eef0f3' }}>
              <Img
                src={staticFile('workflow-enrichissement.png')}
            ...
            >
              ...
              <span style={{ fontSize: 11, color: COLORS.textMuted }}>
                Workflow actif · Relance automatique J+3 et J+7
              </span>
            </div>
          </div>
        </div>
